...
public class All_Ambulance extends Fragment {
    ...
    AmbulanceListAdapter ordersListAdapter;

    List<AmbulanceModel> ordersList = new ArrayList<>();
    int pageNo = 0;
int LANGUAGE_ID=0;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ordersListAdapter = new AmbulanceListAdapter(getContext(), customerID, ordersList, new AmbulanceListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(AmbulanceModel item,int state) {
                if(state==1){
                    ...
                    bundle.putString("service_type", "Ambulance");
                    Fragment fragment;
                    FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                    // Navigate to Products Fragment
    ...
    private void addOrders(List<AmbulanceModel> orderData) {
