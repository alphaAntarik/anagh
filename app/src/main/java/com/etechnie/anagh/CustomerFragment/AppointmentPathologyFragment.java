...
import com.etechnie.anagh.fragment.FragmentPayment;
...
public class AppointmentPathologyFragment extends Fragment {


    PathologyModel doctorModel;
    Context mContext;
    TimeSlot timeSlot;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey("data")) {
          ...
          doctorModel=new Gson().fromJson(data, PathologyModel.class);
        }
        ...
        doctor_specilist.setText(doctorModel.getDescription());
        String time="";
        ...
        clinic_address.setText(doctorModel.getAddress());
