...
import com.etechnie.anagh.databases.User_Recents_DB;
import com.etechnie.anagh.fragment.My_Cart;
import com.etechnie.anagh.fragment.Product_Description;
...
*/
                ...
                holder.product_price_new.setText(ConstantValues.CURRENCY_SYMBOL +""+ new DecimalFormat("#0.00").format(Double.parseDouble(nFormate(Double.parseDouble(product.getProductsPrice())))));
            }
