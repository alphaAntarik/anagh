...
import com.etechnie.anagh.AdminAdapter.HospitalListAdapter;
...
public class All_Hospital extends Fragment {
    ...
    HospitalListAdapter ordersListAdapter;

    List<HospitalModel> ordersList = new ArrayList<>();
    int pageNo = 0;
int LANGUAGE_ID=0;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ordersListAdapter = new HospitalListAdapter(getContext(), customerID, ordersList, new HospitalListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(HospitalModel item,int state) {
                if(state==1){
                    ...
                    bundle.putString("service_type", "Hospital");
                    Fragment fragment;
                    FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                    // Navigate to Products Fragment
    ...
    private void addOrders(List<HospitalModel> orderData) {
