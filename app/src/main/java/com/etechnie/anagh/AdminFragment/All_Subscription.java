...
import com.etechnie.anagh.AdminAdapter.ClinicListAdapter;
import com.etechnie.anagh.AdminAdapter.SubscriptionListAdapter;
...
public class All_Subscription extends Fragment {
    ...
    SubscriptionListAdapter ordersListAdapter;

    List<SubscriptionModel> ordersList = new ArrayList<>();
    int pageNo = 0;
int LANGUAGE_ID=0;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        add.setText("Create Subscription");
        ...
        ordersListAdapter = new SubscriptionListAdapter(getContext(), customerID, ordersList, new SubscriptionListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(SubscriptionModel item,int state) {
                if(state==1){
                    ...
                    fragment = new Create_Subcription();
    ...
    private void addOrders(List<SubscriptionModel> orderData) {
    ...
    public void FetchAllSubscription() {



        Call<ResponseData<Document<SubscriptionModel>>> call = APIClient.getInstance()
                .getAllSubscription(1,10)
                ;

        call.enqueue(new Callback<ResponseData<Document<SubscriptionModel>>>() {
            @Override
            public void onResponse(Call<ResponseData<Document<SubscriptionModel>>> call, retrofit2.Response<ResponseData<Document<SubscriptionModel>>> response) {
            ...
            @Override
            public void onFailure(Call<ResponseData<Document<SubscriptionModel>>> call, Throwable t) {
