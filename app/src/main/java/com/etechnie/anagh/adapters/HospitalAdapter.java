...
public class HospitalAdapter extends RecyclerView.Adapter<HospitalAdapter.MyViewHolder> {
    ...
    Context context;
    List<HospitalModel> categoriesList;


    public HospitalAdapter(Context context, List<HospitalModel> categoriesList, String isSubCategory) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final HospitalModel categoryDetails = categoriesList.get(position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            categoryInfo.putString("service_type", isSubCategory);
