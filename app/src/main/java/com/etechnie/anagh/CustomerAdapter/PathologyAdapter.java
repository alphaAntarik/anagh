package com.etechnie.anagh.CustomerAdapter;
...
public class PathologyAdapter extends RecyclerView.Adapter<PathologyAdapter.MyViewHolder> {

    String service_type;

    Context context;
    List<PathologyModel> categoriesList;


    public PathologyAdapter(Context context, List<PathologyModel> categoriesList, String service_type) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_hospital_adapter, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final PathologyModel categoryDetails = categoriesList.get(position);
