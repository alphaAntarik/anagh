...
public class AmbulanceListAdapter extends RecyclerView.Adapter<AmbulanceListAdapter.MyViewHolder> {
    ...
    Context context;
    String customerID;
    List<AmbulanceModel> ordersList;

    public interface OnItemClickListener {
        void onItemClick(AmbulanceModel item, int id);
    }

    private OnItemClickListener listener;

    public AmbulanceListAdapter(Context context, String customerID, List<AmbulanceModel> ordersList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final AmbulanceModel ProductDetails = ordersList.get(position);
