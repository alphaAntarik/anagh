...
public class All_Clinic extends Fragment {
    ...
    ClinicListAdapter ordersListAdapter;

    List<ClinicModel> ordersList = new ArrayList<>();
    int pageNo = 0;
int LANGUAGE_ID=0;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ordersListAdapter = new ClinicListAdapter(getContext(), customerID, ordersList, new ClinicListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(ClinicModel item,int state) {
                if(state==1){
    ...
    private void addOrders(List<ClinicModel> orderData) {
