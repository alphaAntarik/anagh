...
import com.etechnie.anagh.adapters.MedicalTypeListAdapter;
...
public class Categories_1 extends Fragment {
    ...
    MedicalTypeListAdapter categoryListAdapter;
    List<MedicalTypeModel> allMedicalTypeList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        allMedicalTypeList=new ArrayList<>();
        allMedicalTypeList=((App) getContext().getApplicationContext()).getMedicalTypeList();
        ...
        categoryListAdapter = new MedicalTypeListAdapter(getContext(), allMedicalTypeList, false);
