...
import com.etechnie.anagh.adapters.CategoryListAdapter_6;
...
public class Categories_6 extends Fragment {
    ...
    List<MedicalProblemModel> mainCategoriesList;
    String data="";
    @Nullable
    @Override
        ...
        if (getArguments() != null) {
            ...
            if (getArguments().containsKey("data")) {
                ...
                if(!data.equalsIgnoreCase("")){
                    Type listType = new TypeToken<ArrayList<MedicalProblemModel>>(){}.getType();
                    mainCategoriesList = new Gson().fromJson(data, listType);
                }
            }
        }
