...
import com.etechnie.anagh.utils.ImagePickerTest;
...
public class Signup extends AppCompatActivity {
    ...
    private void pickImage() {
        ...
        Intent chooseImageIntent = ImagePickerTest.getImagePickerIntent(Signup.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == PICK_IMAGE_ID) {
                ...
                Bitmap bitmap = ImagePickerTest.getImageFromResult(Signup.this, resultCode, data);
