...
public class AmbulanceAdapter extends RecyclerView.Adapter<AmbulanceAdapter.MyViewHolder> {
    ...
    Context context;
    List<AmbulanceModel> categoriesList;


    public AmbulanceAdapter(Context context, List<AmbulanceModel> categoriesList, String service_type) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final AmbulanceModel categoryDetails = categoriesList.get(position);
