...
import com.etechnie.anagh.CustomerAdapter.PathologyAdapter;
...
public class FragmentPathology extends Fragment {
    ...
    PathologyAdapter categoryListAdapter;

    List<CategoryDetails> allCategoriesList;
    List<PathologyModel> mainCategoriesList;
    int CategoryID=0;
    String service_type="";
    @Nullable
    @Override
...
//        }
        ...
        categoryListAdapter = new PathologyAdapter(getContext(), mainCategoriesList, service_type);
    ...
    private void CallData(List<PathologyModel> data) {
