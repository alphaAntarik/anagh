...
public class ClinicListAdapter extends RecyclerView.Adapter<ClinicListAdapter.MyViewHolder> {

    Context context;
    String customerID;
    List<ClinicModel> ordersList;

    public interface OnItemClickListener {
        void onItemClick(ClinicModel item, int id);
    }

    private OnItemClickListener listener;

    public ClinicListAdapter(Context context, String customerID, List<ClinicModel> ordersList, OnItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_card_clinic_items, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final ClinicModel ProductDetails = ordersList.get(position);
...
//
       ...
       // holder.quantity.setText("" + ProductDetails.getAddress());
        holder.cart_item_sub_price.setText(ProductDetails.getDescription());
