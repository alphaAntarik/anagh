...
public class PathologyListAdapter extends RecyclerView.Adapter<PathologyListAdapter.MyViewHolder> {

    Context context;
    String customerID;
    List<PathologyModel> ordersList;

    public interface OnItemClickListener {
        void onItemClick(PathologyModel item, int id);
    }

    private OnItemClickListener listener;

    public PathologyListAdapter(Context context, String customerID, List<PathologyModel> ordersList, OnItemClickListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_card_ambulance_items, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final PathologyModel ProductDetails = ordersList.get(position);
